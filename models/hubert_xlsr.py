...
class SERModelHuBERT(nn.Module):
    def __init__(self, pretrained_name="facebook/hubert-large-ls960-ft", num_labels=2):
        super().__init__()
        self.hubert = HubertModel.from_pretrained(pretrained_name)
